      ...
      <div id="story" className="story">
        ...
        <div className="story__left">
          <div className="story__suggestions">
            ...
            {suggestions ? suggestions.map(suggestion => <p className="story__suggestions-item">
              {suggestion}</p>) : <p className="story__suggestions-item">Sorry, We Don't Have Any Suggestions. You are on your Own Buddy!</p>}
          </div>
